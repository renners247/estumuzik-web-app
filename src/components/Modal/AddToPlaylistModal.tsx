          ...
          {!isCreating ? (
            ...
            <div className="flex gap-2 animate-in slide-in-from-top-2 duration-200">
              ...
              <button
                ...
                className="px-4 py-2 w-20 bg-indigo-600 text-white text-xs font-bold rounded-lg hover:bg-indigo-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
              >
